...
SRCS=main.cpp gfxutil.cpp stage.cpp game_data.cpp util.cpp player.cpp config.cpp game.cpp hud.cpp menu.cpp character.cpp animated_sprite.cpp char.cpp text.cpp
TARGET=fedf
CFLAGS=
INCLUDES=-I./
LFLAGS=
