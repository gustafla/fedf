...
void Game::playPunchSound(unsigned int player) {
    gameData->sounds->play(PUNCH_SOUNDS[int((1.0-(players[player].getHealth()/100.0))*(NUM_PUNCH_SOUNDS-1))]);
}
