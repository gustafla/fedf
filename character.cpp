...
name(iname),
dir(idir) {
    picArea = buildRect(0, 0, CHARACTER_FRAME_SIZE, CHARACTER_FRAME_SIZE);
	file2surface(dir+CHARACTER_RIGHT_SPRITE_FILE, &pic);
	file2surface(dir+CHARACTER_LEFT_SPRITE_FILE, &lpic);
}
